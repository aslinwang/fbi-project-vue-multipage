...
const config = {
    entry: './src/pages/main/index.ssr.js', //entries(),
    target: 'node',
    ...
    output: {
        ...
        path: prod ? ctx.utils.path.cwd(ctx.options.server.ssrRoot) : '/',
    ...
    resolve: {
        ...
        unsafeCache: true,
        alias: Object.assign({}, webpackOpts.alias, prod ? webpackOpts.aliasProd : {})
    },
    resolveLoader: {
        modules: ctx.nodeModulesPaths
    },
    ...
    module: {
        ...
        //     test: /\.(html|hbs)$/i,
        //     exclude: function (path) {
        //         // 路径中含有 components|views 的就不去解析。
        //         const isNpmModule = !!path.match(/components|views/)
        //         return isNpmModule
        //     },
        //     use: [{
    ...
    plugins: [
        ...
        prod ? noop : new webpack.NoEmitOnErrorsPlugin(),
        extractCss ?
